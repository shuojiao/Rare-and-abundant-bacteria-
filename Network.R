...
a<-with(dd,wilcox.test(betweenness,category))
fdrtool(a$p.value,statistic="pvalue")
a<-with(dd,wilcox.test(closeness,category))
fdrtool(a$p.value,statistic="pvalue")
a<-with(dd,wilcox.test(eigenvector,category))
fdrtool(a$p.value,statistic="pvalue")
...
fdrtool(a$p.value,statistic="pvalue")
a<-with(dd_core,wilcox.test(betweenness,category))
fdrtool(a$p.value,statistic="pvalue")
a<-with(dd_core,wilcox.test(closeness,category))
fdrtool(a$p.value,statistic="pvalue")
a<-with(dd_core,wilcox.test(eigenvector,category))
fdrtool(a$p.value,statistic="pvalue")
